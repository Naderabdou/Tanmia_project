...
Route::group(
    ...
    ], function()
    {
        ...
        Route::prefix('admin')->name('admin.')->group(function () {
            ...
            Route::get('messages/user/{id}', [MessagesController::class,'show'])->name('messages.show');
            Route::resource('messages', MessagesController::class)->except('create','store','edit','update','show');
