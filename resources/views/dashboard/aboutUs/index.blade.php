...
@section('subtitle', __('general.about_us'))
...
@section('content')
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel">@lang('general.create') @lang('general.about_us')</h5>
                ...
                <form action="{{route('admin.aboutUs.store')}}" method="post" id="form_create_aboutUs" enctype="multipart/form-data">
                    @csrf
                            ...
                            <div class="col-md-4 aboutUs-add">
                                ...
                                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop" style="margin-bottom: 22px">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="form-input mdc-text-field__input" id="text-field-hero-input"  name="{{$locale}}[name]" value="{{ old($locale.'.title') }}" required>
                                ...
                                <div class="col-md-8 aboutUs-add">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop" style="margin-bottom: 22px">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            ...
                                            <textarea name="{{$locale}}[description]"   class="form-input mdc-text-field__input" id="text-field-hero-input">{{ old($locale.'.description') }}</textarea>
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
    ...
    <div class="mdc-layout-grid" style="margin-top: 20px;" >
        <div style="text-align: @if(app()->getLocale() === 'ar' ) right @elseif(app()->getLocale() === "he") right @else left @endif">
            ...
            <form method="post" action="{{ route('admin.aboutUs.bulk_delete') }}" style="display: inline-block;" id="bulk_delete_aboutUs">
                @csrf
                @method('delete')
            ...
            <form method="post" action="{{route('admin.aboutUs.status')}}" style="display: inline-block;" id="status_aboutUs">
                @csrf
                @method('POST')
                <input type="hidden" name="record_ids" class="record-ids">
...
<script>
    ...
    $(document).ready(function() {
       ...
       $(document).on('submit','#bulk_delete_aboutUs',function (e){
           ...
           $.ajax({
               type: "post",
               url: "{{route('admin.aboutUs.bulk_delete')}}",
               data: formData,
               processData: false,
               contentType: false,
               success: function (response) {
        ...
        $(document).on('submit','#status_aboutUs',function (e){
            ...
            $.ajax({
                type: "post",
                url: "{{route('admin.aboutUs.status')}}",
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
