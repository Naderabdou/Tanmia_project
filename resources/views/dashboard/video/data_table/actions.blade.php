         ...
         <div class="modal-content">
             ...
             <form action="{{route('admin.video.update',$video->id)}}" method="post" id="form_update_video" data-id="" enctype="multipart/form-data">
                 ...
                 <div class="modal-body">
                     <div class="container">
                         <div class="row">
                             <div class="form-group col-md-12" id="video-edit"  style="text-align: @if(app()->getLocale() === 'ar' ) right @elseif(app()->getLocale() === "he") right @else left @endif">

                                 <label for="Image" class="floating-label">@lang('general.video')</label>
