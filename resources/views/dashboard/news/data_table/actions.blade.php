                             ...
                             @foreach(config('translatable.locales') as $locale)
                                 ...
                                 <div class="col-md-8 news-edit">
                                     ...
                                     <div style="text-align: @if(app()->getLocale() === 'ar' ) right @elseif(app()->getLocale() === "he") right @else left @endif" class="form-input">
                                         ...
                                         <textarea   name="{{$locale}}[description]"  class="form-control ckeditor" id="{{$locale}}-description" rows="3"></textarea>
                                     </div>
                                 </div>
                             ...
                             @endforeach
                                 ...
                                 <div class="col-md-4 news-edit" style="margin-top: 10px;">
                                     <div  style="text-align: @if(app()->getLocale() === 'ar' ) right @elseif(app()->getLocale() === "he") right @else left @endif" class="form-group">
                                         ...
                                         <input  type="text" class="form-control" name="{{$locale}}[short_name]" id="{{$locale}}-short_name" value="{{$news->translate($locale)->short_name}}">
                                     </div>
                                 </div>
                                 @endforeach

                             <div class="form-group col-md-12 news-edit"  style="text-align: @if(app()->getLocale() === 'ar' ) right @elseif(app()->getLocale() === "he") right @else left @endif">
