...
<?php $__env->startSection('content'); ?>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo app('translator')->get('general.create'); ?> <?php echo app('translator')->get('general.new'); ?></h5>
                ...
                <form action="<?php echo e(route('admin.news.store')); ?>" method="post" id="form_create_news" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="col-md-4 news-add">

                                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop" style="margin-bottom: 22px">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        <input class="form-input mdc-text-field__input" id="text-field-hero-input"  name="<?php echo e($locale); ?>[title]" value="<?php echo e(old($locale.'.title')); ?>" required>
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                                <label for="text-field-hero-input" class="mdc-floating-label"><?php echo app('translator')->get('general.'.$locale.'.title'); ?></label>
                                            </div>
                                ...
                                <div class="col-md-8 news-add">

                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop" style="margin-bottom: 22px">
                                        <div class="mdc-text-field mdc-text-field--outlined">

                                            <textarea name="<?php echo e($locale); ?>[description]"   class="form-input mdc-text-field__input" id="text-field-hero-input" required><?php echo e(old($locale.'.description')); ?></textarea>
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                            ...
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="col-md-4 news-add">
                                    ...
                                    <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop" style="margin-bottom: 22px">
                                        <div class="mdc-text-field mdc-text-field--outlined">
                                            <input class="form-input mdc-text-field__input" id="text-field-hero-input"  name="<?php echo e($locale); ?>[short_name]" value="<?php echo e(old($locale.'.short_name')); ?>" required>
                                            <div class="mdc-notched-outline">
                                                <div class="mdc-notched-outline__leading"></div>
                                                <div class="mdc-notched-outline__notch">
                                                    <label for="text-field-hero-input" class="mdc-floating-label"><?php echo app('translator')->get('general.'.$locale.'.short_name'); ?></label>
                                                </div>
                                                <div class="mdc-notched-outline__trailing"></div>
                                            </div>
                                        </div>
                                ...
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                <div class="form-group col-md-12 news-add">
                                <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop" style="margin-bottom: 22px">
                                    <div class="mdc-text-field mdc-text-field--outlined">
                                        ...
                                        <div class="mdc-notched-outline">
                                            <div class="mdc-notched-outline__leading"></div>
                                            <div class="mdc-notched-outline__notch">
                                                <label for="text-field-hero-input-category_id" class="mdc-floating-label"><?php echo app('translator')->get('general.categories'); ?></label>
                                            </div>
                                            <div class="mdc-notched-outline__trailing"></div>
                                        </div>
                            ...
                            <div class="form-group col-md-12" id="loading-news-add"></div>
    ...
    <div class="mdc-layout-grid" style="margin-top: 20px;" >
        <div style="text-align: <?php if(app()->getLocale() === 'ar' ): ?> right <?php elseif(app()->getLocale() === "he"): ?> right <?php else: ?> left <?php endif; ?>">
            ...
            <form method="post" action="<?php echo e(route('admin.news.bulk_delete')); ?>" style="display: inline-block;" id="bulk_delete_news">
                <?php echo csrf_field(); ?>
            ...
            <form method="post" action="<?php echo e(route('admin.news.status')); ?>" style="display: inline-block;" id="status_news">
                <?php echo csrf_field(); ?>
                        ...
                        <table style="width: 100%;" class="table m-0" id="news-table">
                            ...
                            <tr >
                             ...
                             <th><?php echo app('translator')->get('general.id'); ?></th>
                                ...
                                <th><?php echo app('translator')->get('general.short_name'); ?></th>
                                <th><?php echo app('translator')->get('general.description'); ?></th>
                                <th><?php echo app('translator')->get('general.image'); ?></th>
                                <th><?php echo app('translator')->get('general.category'); ?></th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        let rolesTable = $('#news-table').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('admin.news.data')); ?>',
            },
            columns: [
        ...
        $(document).on('submit','#form_create_news',function (e){
            ...
            $('#loading-news-add').empty().append(loader);
            $('.news-add').css('display','none');
            $.ajax({
                type: "post",
                url: "<?php echo e(route('admin.news.store')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
                    $('#loading-news-add').empty();
                    $('.news-add').css('display','block');
        ...
        $(document).on('submit','#form_update_news',function (e){
            ...
            $('#loading-news-edit').empty().append(loader);
       ...
       $(document).on('submit','#bulk_delete_news',function (e){
           ...
           $.ajax({
               type: "post",
               url: "<?php echo e(route('admin.news.bulk_delete')); ?>",
               data: formData,
               processData: false,
               contentType: false,
               success: function (response) {
        ...
        $(document).on('submit','#status_news',function (e){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('admin.news.status')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
...
<?php echo $__env->make('.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project new\Project\resources\views/dashboard/news/index.blade.php ENDPATH**/ ?>