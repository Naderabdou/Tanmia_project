<?php $__env->startSection('subtitle', __('general.categories')); ?>
...
<?php $__env->startSection('content'); ?>
        ...
        <div class="modal-dialog">
            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="exampleModalLabel"><?php echo app('translator')->get('general.create'); ?></h5>
                ...
                <form action="<?php echo e(route('admin.categories.store')); ?>" method="post" id="form_create_category">
                    <?php echo csrf_field(); ?>
                <div class="modal-body">
                    <?php $__currentLoopData = config('translatable.locales'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $locale): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-6-desktop category-add" style="margin-bottom: 22px">
                            <div class="mdc-text-field mdc-text-field--outlined">
                                <input class="mdc-text-field__input" id="text-field-hero-input"  name="<?php echo e($locale); ?>[name]" value="<?php echo e(old($locale.'.name')); ?>" required>
                    ...
                    <div class="form-group col-md-12" id="loading-category-add"></div>
    ...
    <div class="mdc-layout-grid" style="margin-top: 20px;" >
        <div style="text-align: <?php if(app()->getLocale() === 'ar' ): ?> right <?php elseif(app()->getLocale() === "he"): ?> right <?php else: ?> left <?php endif; ?>">
            ...
            <form method="post" action="<?php echo e(route('admin.categories.bulk_delete')); ?>" style="display: inline-block;" id="bulk_delete_categories">
                <?php echo csrf_field(); ?>
            ...
            <form method="post" action="<?php echo e(route('admin.categories.status')); ?>" style="display: inline-block;" id="status_categories">
                <?php echo csrf_field(); ?>
                        ...
                        <table style="width: 100%;" class="table m-0" id="category-table">
                            ...
                            <tr >
                             ...
                             <th><?php echo app('translator')->get('general.id'); ?></th>
                                ...
                                <th><?php echo app('translator')->get('general.news_count'); ?></th>
...
<script>
    $(document).ready(function() {
        ...
        let rolesTable = $('#category-table').DataTable({
            ...
            ajax: {
                url: '<?php echo e(route('admin.categories.data')); ?>',
            },
            columns: [
        ...
        $(document).on('submit','#form_create_category',function (e){
            ...
            $('#loading-category-add').empty().append(loader);
        ...
        $(document).on('submit','#form_update_category',function (e){
            ...
            $('#loading-category-edit').empty().append(loader);
       ...
       $(document).on('submit','#bulk_delete_categories',function (e){
           ...
           $.ajax({
               type: "post",
               url: "<?php echo e(route('admin.categories.bulk_delete')); ?>",
               data: formData,
               processData: false,
               contentType: false,
               success: function (response) {
        ...
        $(document).on('submit','#status_categories',function (e){
            ...
            $.ajax({
                type: "post",
                url: "<?php echo e(route('admin.categories.status')); ?>",
                data: formData,
                processData: false,
                contentType: false,
                success: function (response) {
...
<?php echo $__env->make('.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\project new\Project\resources\views/dashboard/categories/index.blade.php ENDPATH**/ ?>